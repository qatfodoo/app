...
CommentCard.prototype.initializeVote = function () {
  ...
  this.commentVote.on('CommentVote:error', this.showCommentError.bind(this));
  this.commentVote.on('CommentVote:error-clean', this.cleanCommentError.bind(this));
};

CommentCard.prototype.showCommentError = function (message) {
  this.find('.error').html(message);
};

CommentCard.prototype.cleanCommentError = function () {
