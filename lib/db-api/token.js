...
/**
 * Create reply email Token for a citizen
 *
 * @param {Object} citizen object for which the
 * email validation Token is created.
 * @param {Function} fn callback function
...
exports.createReplyEmail = function createReplyEmail(citizen, meta, fn) {
  log('Creating new reply email token for citizen %j', citizen);
  return createToken(citizen, meta, 'reply-email', fn);
};
